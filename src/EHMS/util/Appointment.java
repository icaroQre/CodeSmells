...
public class Appointment 
{
	...
	public void bookAppointment(int patientID) {
        try {
            ...
            String query = "INSERT INTO Appointments (PatientID, Problem, DoctorID, DoctorFees, PaymentStatus) VALUES ('" +
                    patientID + "', '" + problemDescription + "', '" + doctorID + "', 'Pending', 'Not Paid')";
